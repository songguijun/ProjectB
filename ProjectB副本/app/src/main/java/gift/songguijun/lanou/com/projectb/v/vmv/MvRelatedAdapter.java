...
public class MvRelatedAdapter extends BaseAdapter {
    private List<MVBean.DataBean.RelatedVideosBean> data;
    private Context context;

    public void setData(List<MVBean.DataBean.RelatedVideosBean> data) {
        this.data = data;
        notifyDataSetChanged();
    }

    public MvRelatedAdapter(Context context) {
