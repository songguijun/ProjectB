...
public class MostPeopleAdapter extends RecyclerView.Adapter<MostPeopleAdapter.MyViewHoder> {
    private List<VideoBean.DataBean.MostPeopleVideosBean>data;
    private Context context;

    public MostPeopleAdapter(Context context) {
        this.context = context;
    }

    public void setData(List<VideoBean.DataBean.MostPeopleVideosBean> data) {
        this.data = data;
