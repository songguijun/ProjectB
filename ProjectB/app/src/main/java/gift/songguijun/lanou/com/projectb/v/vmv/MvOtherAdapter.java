...
public class MvOtherAdapter extends BaseAdapter {
    private List<MVBean.DataBean.ArtistOtherVideosBean> data;
    private Context context;

    public MvOtherAdapter(Context context) {
        this.context = context;
    }

    public void setData(List<MVBean.DataBean.ArtistOtherVideosBean> data) {
        this.data = data;
