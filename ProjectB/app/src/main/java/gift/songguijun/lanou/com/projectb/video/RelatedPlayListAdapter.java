...
public class RelatedPlayListAdapter extends BaseAdapter{
    private List<VideoBean.DataBean.RelatedPlayListBean>data;
    private Context context;

    public RelatedPlayListAdapter(Context context) {
        this.context = context;
    }

    public void setData(List<VideoBean.DataBean.RelatedPlayListBean> data) {
        this.data = data;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.tv_count.setText(data.get(i).getCreator().getNickName());
